    ...
    >
          ...
          >
            <Card style={{ padding: "25px" }}>
              ...
              >
                <div>
                  {currentDemoResults
                    .slice(0, Math.ceil(currentDemoResults.length / 2))
                    .map((result, index) => (
                      <motion.div
                        key={index}
                        initial={{ opacity: 0, x: -20 }}
                ...
                <div>
                  {currentDemoResults
                    .slice(Math.ceil(currentDemoResults.length / 2))
                    .map((result, index) => (
                      <motion.div
                        ...
                        transition={{
                          delay:
                            (index + Math.ceil(currentDemoResults.length / 2)) *
                            0.1,
                        }}
                        style={{
                          display: "flex",
              ...
              >
                ...
                >
                  ...
                  <br />
                  • Auto-generates follow-up tasks based on incident resolution
                  <br />
                  • Updates performance dashboards and ORR reports in real-time
      ...
      <Card style={{ padding: "25px" }}>
        ...
        >
          ...
          >
            💡 <strong>Stay Protected:</strong> 94% compliance score this month.
            The more you resolve through Samara, the stronger your audit trail
            becomes. Every action logged automatically.
          </Text>
        </div>
      </Card>
    </div>
