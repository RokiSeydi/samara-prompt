...
export const TransportationDemo: React.FC = () => {
  const [currentStep, setCurrentStep] = useState<
    "signin" | "onboarding" | "processing" | "dashboard"
  >("signin");
  ...
  const onboardingQuestions = [
    ...
    {
      question:
        "How do you usually communicate with teams during service issues?",
      type: "radio" as const,
  ...
  const demoScenarios = [
    {
      ...
      description:
        "Signal failure reported at Pitsea Junction affecting the Southend line. Show me impacted services, get replacement crew sorted, notify all teams, and start the incident log for compliance.",
      urgency: "high",
      icon: <AlertRegular />,
      results: [
        {
    ...
    },
    {
      ...
      description:
        "Multiple drivers called in sick for tomorrow's peak hours. Need to reorganize shifts, contact relief drivers, and ensure service continuity while staying within fatigue regulations.",
      urgency: "high",
      icon: <PersonRunningRegular />,
      results: [
        {
    ...
    },
    {
      ...
      description:
        "Need to pull together the monthly performance report for ORR submission. Analyze delay minutes, punctuality, and identify improvement areas across all routes.",
      urgency: "medium",
      icon: <DocumentRegular />,
      results: [
        {
      ...
      >
        ...
        >
          <div style={{ marginBottom: "40px" }}>
            <VehicleSubwayRegular
              style={{ fontSize: "80px", color: "white", marginBottom: "20px" }}
            />
            <Text
              style={{
                fontSize: "36px",
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              Building your personalized operations profile based on your
              ...
              <div style={{ marginBottom: "30px" }}>
                {currentQuestion.options.map((option, index) => (
                  <Checkbox
                    ...
                    label={option}
                    checked={(
                      onboardingData[currentQuestion.key] as string[]
                    ).includes(option)}
                    onChange={(_, data) =>
                      handleOnboardingInput(option, data.checked === true)
                    }
                    style={{
                      marginBottom: "12px",
                      display: "block",
    ...
    >
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: "15px" }}>
          ...
          <div>
            <Text
              style={{ fontSize: "24px", fontWeight: 600, display: "block" }}
            >
              SAMARA AI
            </Text>
      ...
      >
        ...
        {/* Right Column - Samara Chat Interface */}
        <div>
          <Card style={{ padding: "25px" }}>
            <Text
              style={{
            ...
            >
              ...
              >
                <VehicleSubwayRegular
                  style={{ color: "#0078D4", fontSize: "20px" }}
                />
              ...
              {demoScenarios.map((scenario, index) => (
                <div
                  ...
                  style={{
                    ...
                    marginBottom: "8px",
                    backgroundColor:
                      selectedScenario === index ? "#E3F2FD" : "#F8F9FA",
                    borderRadius: "8px",
                    border:
            ...
            >
              {isProcessingDemo ? "🔄 Getting it done..." : `🚀 Get it done`}
            </Button>
          </Card>
        </div>
      </div>
        ...
        {showResults && (
          ...
          >
            <Card style={{ padding: "25px" }}>
              ...
              >
                ✅ Scenario Complete -{" "}
                {demoScenarios[selectedScenario]?.title}
              </Text>
              ...
              >
                ...
                <Text style={{ fontSize: "13px", color: "#666" }}>
                  Traditional manual process: ~25-30 minutes | Samara:{" "}
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "20px", marginBottom: "20px" }}>
                <div>
                  {currentDemoResults.slice(0, Math.ceil(currentDemoResults.length / 2)).map((result, index) => (
                    <motion.div
                      key={index}
                      initial={{ opacity: 0, x: -20 }}
                      animate={{ opacity: 1, x: 0 }}
                ...
                <div>
                  {currentDemoResults.slice(Math.ceil(currentDemoResults.length / 2)).map((result, index) => (
                    <motion.div
                      key={index + Math.ceil(currentDemoResults.length / 2)}
                      initial={{ opacity: 0, x: -20 }}
                      animate={{ opacity: 1, x: 0 }}
                      transition={{ delay: (index + Math.ceil(currentDemoResults.length / 2)) * 0.1 }}
                      style={{
                        display: "flex",
                        flexDirection: "column",
                        gap: "8px",
              ...
              >
                ...
                >
                  🔒 All actions logged for compliance. Full audit trail
                  available instantly.
                </Text>
              </div>
              ...
              >
                ...
                >
                  • Samara monitors progress and sends updates to your Teams
                  <br />
                  • Auto-generates follow-up tasks based on incident
                  resolution
                  <br />
                  • Updates performance dashboards and ORR reports in
                  real-time
                  <br />• Learns from this scenario to handle similar issues
                  faster next time
                </Text>
              </div>
            </Card>
      ...
      {/* Compliance Tracker - Bottom Section */}
      <Card style={{ padding: "25px" }}>
        <Text
          style={{
            fontSize: "20px",
          ...
          {complianceStatus.map((item, index) => (
            ...
            >
              ...
              >
                ...
                <div style={{ flex: 1 }}>
                  <Text style={{ fontWeight: 600, display: "block", fontSize: "14px" }}>
                    {item.name}
                  </Text>
                  <Text style={{ fontSize: "13px", color: "#666" }}>
                    {item.detail}
        ...
        >
          ...
          >
            💡 <strong>Stay Protected:</strong> 94% compliance score this
            month. The more you resolve through Samara, the stronger your
            audit trail becomes. Every action logged automatically.
          </Text>
        </div>
      </Card>
    </div>
