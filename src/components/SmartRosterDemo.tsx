...
const SmartRosterDemo: React.FC = () => {
  ...
  const handleApplyChange = async (
    ...
    setTimeout(async () => {
      ...
      const optimization = await smartRosterOptimizer.applyChange(
        changeType,
        entityId
      );
      const results = smartRosterOptimizer.generateWorkflowResults(
        optimization,
        description
      );
  ...
  if (state.step === "overview") {
    return (
      ...
      >
        ...
        >
          <VehicleBusRegular
            style={{ fontSize: "80px", color: "#0078D4", marginBottom: "20px" }}
          />
          <Text
            style={{
              fontSize: "28px",
          ...
          >
            Loading your current roster from{" "}
            <strong>transport_roster_2025.xlsx</strong>
            <br />
            Analyzing driver schedules, vehicle allocations, and route
            assignments...
          </Text>
          <Spinner size="large" />
          <Text
            style={{ fontSize: "14px", color: "#8A8886", marginTop: "15px" }}
          >
      ...
      >
        <div style={{ maxWidth: "1200px", margin: "0 auto", color: "white" }}>
          <div style={{ textAlign: "center", marginBottom: "40px" }}>
            ...
            >
              Current roster shows <strong>8 drivers</strong>,{" "}
              <strong>8 vehicles</strong>, and <strong>5 active routes</strong>
              <br />3 conflicts detected requiring immediate attention
            </Text>
          </div>
          ...
          >
            ...
            >
              Click any scenario below to see how the Smart Roster Optimizer
              automatically resolves conflicts and rebalances the entire
              ...
              <Card
                ...
                onClick={() =>
                  handleApplyChange(
                    "driver_sick",
                    "D005",
                    "Driver David Chen called in sick"
                  )
                }
              >
                <PersonRegular
              ...
              <Card
                ...
                onClick={() =>
                  handleApplyChange(
                    "route_cancelled",
                    "R008",
                    "Route 78 weekend service cancelled"
                  )
                }
              >
                <CalendarRegular
        ...
        >
          ...
          <div style={{ marginTop: "30px", textAlign: "left" }}>
            <div
              style={{
                marginBottom: "10px",
                opacity: state.progress > 20 ? 1 : 0.3,
            ...
            >
              <Text
                style={{
                  fontSize: "14px",
                  color: state.progress > 20 ? "#107C10" : "#8A8886",
                }}
              >
            ...
            <div
              style={{
                marginBottom: "10px",
                opacity: state.progress > 40 ? 1 : 0.3,
                transition: "opacity 0.5s",
              }}
            >
              <Text
                style={{
                  fontSize: "14px",
                  color: state.progress > 40 ? "#107C10" : "#8A8886",
                }}
              >
            ...
            <div
              style={{
                marginBottom: "10px",
                opacity: state.progress > 60 ? 1 : 0.3,
                transition: "opacity 0.5s",
              }}
            >
              <Text
                style={{
                  fontSize: "14px",
                  color: state.progress > 60 ? "#107C10" : "#8A8886",
                }}
              >
            ...
            <div
              style={{
                marginBottom: "10px",
                opacity: state.progress > 80 ? 1 : 0.3,
                transition: "opacity 0.5s",
              }}
            >
              <Text
                style={{
                  fontSize: "14px",
                  color: state.progress > 80 ? "#107C10" : "#8A8886",
                }}
              >
      ...
      >
        <div style={{ maxWidth: "1400px", margin: "0 auto", color: "white" }}>
          <div style={{ textAlign: "center", marginBottom: "30px" }}>
            ...
            >
              <strong>{selectedChange}</strong> - Roster automatically
              rebalanced in under 30 seconds
            </Text>
                ...
                >
                  ...
                  {result.data && (
                    <div style={{ marginBottom: "20px", flex: 1 }}>
                      ...
                      {result.app === "Analytics" &&
                        result.data.cost_analysis && (
                          <div>
                            <div
                              style={{
                                display: "grid",
                            ...
                            >
                              ...
                              >
                                ...
                                <Text
                                  style={{ fontSize: "11px", color: "#605E5C" }}
                                >
                                  Daily Savings
                                </Text>
                              </div>
